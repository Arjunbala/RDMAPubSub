...
def read_data(data_dir):
    ...
    tp = [1.7041, 1.9457, 3.081, 5.8846, 11.9222, 23.8619, 212.768, 319.438, 314.764, 317.988]
...
def bar_plot():
    ...
    plot_path = os.path.join(plots_dir, "micro_producer_throughput.pdf")
